...
/// NOTE: Qwen3-Embedding-0.6B (64.33 MTEB, +15% better) requires last-token pooling
/// which isn't compatible with current mean-pooling pipeline. See docs/QWEN3_UPGRADE.md
