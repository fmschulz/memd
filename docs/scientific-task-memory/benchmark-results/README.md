...
This directory now contains the source-of-truth corpus and report outputs for Phase 5 benchmarking of memd's task-oriented knowledge artifact layer.
...
- [task_memory_benchmark.py](../../../evals/bench/tools/task_memory_benchmark.py)
- [run_task_memory_benchmark.sh](../../../evals/bench/scripts/run_task_memory_benchmark.sh)
